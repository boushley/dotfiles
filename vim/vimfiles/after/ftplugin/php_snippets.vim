...
exec "Snippet function /*************************<CR><CR>".st."FunctionName".et."<CR><CR>***********************/<CR>".st."public".et." function ".st."FunctionName".et." (".st.et.")<CR>{<CR>".st.et."<CR>}<CR>".st.et
...
"My own snippets
exec "Snippet header /**********************************************<CR><CR>".st.et."<CR><CR>@author: ".st.et."<CR>@date: ".st.et."<CR><CR>********************************************/<CR>".st.et
