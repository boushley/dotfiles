...
Publish the approved tickets. **How** depends on the tracker `/setup-project-for-agents` configured; the tickets are the same either way, only the shape of the blocking edges changes:
